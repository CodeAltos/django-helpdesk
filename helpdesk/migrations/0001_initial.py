...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'helpdesk_queue', (
            ...
            ('socks_proxy_type', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True)),
            ('socks_proxy_host', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True)),
            ('socks_proxy_port', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
